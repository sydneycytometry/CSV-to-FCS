...
# Install packages if required using Bioconductor
if (!requireNamespace("BiocManager", quietly = TRUE))
  install.packages("BiocManager")
BiocManager::install("flowCore")
BiocManager::install("Biobase")

# Install packages if required using standard installation
...
#setwd("/Users/Tom/Desktop/")                          # Set your working directory here (e.g. "/Users/Tom/Desktop/") -- press tab when selected after the '/' to see options
